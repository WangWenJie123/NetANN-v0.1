...
csv_log_path = "/home/wwj/Vector_DB_Acceleration/ref_projects/GPU_FPGA_P2P_Test/eva_logs/faiss_remote_text10M_cpu_disk.csv"
...
if 1:
    # train the index
    xt = deep1B_text1B_dataset.read_fbin(filename=base_dataPath, start_idx=0, chunk_size=10000000)
