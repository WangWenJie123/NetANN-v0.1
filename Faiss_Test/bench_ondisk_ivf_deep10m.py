...
base_dataPath = "/home/wwj/Vector_DB_Acceleration/Vector_Datasets/Remote_Nvme_Vector_Datasets/deep1B/base10M.fbin"
...
csv_log_path = "/home/wwj/Vector_DB_Acceleration/ref_projects/GPU_FPGA_P2P_Test/eva_logs/remote_deep10M_cpu_disk.csv"
...
if 1:
    # train the index
    xt = deep1B_text1B_dataset.read_fbin(filename=base_dataPath, start_idx=0, chunk_size=None)
...
for stage in range(1, 5):
    bno = stage - 1
    xb = deep1B_text1B_dataset.read_fbin(filename=base_dataPath, start_idx=0, chunk_size=None)
