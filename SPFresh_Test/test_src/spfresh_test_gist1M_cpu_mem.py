...
vector_dataset_path = '/app/wwj_test/vector_datasets/gist/'
spfresh_index_path = '/app/wwj_test/SPFresh_Index'
csv_log_path = '/app/wwj_test/eva_logs/spfresh_local_gist_compute_cpu_mem.csv'
...
def main():
    ...
    # read base vectors
    xb = fvecs_read(vector_dataset_path + 'gist_base.fvecs')
    xb_num = xb.shape[0]
    xb_dim = xb.shape[1]
    
    # read query vectors
    xq = fvecs_read(vector_dataset_path + 'gist_query.fvecs')
    # xq_num = xq.shape[0]
    xq_num = 1
    ...
    # read groundtruth
    groundtruth = ivecs_read(vector_dataset_path + 'gist_groundtruth.ivecs')
