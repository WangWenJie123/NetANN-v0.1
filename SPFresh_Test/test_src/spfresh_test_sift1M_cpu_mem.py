...
vector_dataset_path = '/app/wwj_test/vector_datasets/sift1M/'
spfresh_index_path = '/app/wwj_test/SPFresh_Index'
csv_log_path = '/app/wwj_test/eva_logs/spfresh_local_sift1M_compute_cpu_mem.csv'
...
def main():
    ...
    # read base vectors
    xb = fvecs_read(vector_dataset_path + 'sift_base.fvecs')
    xb_num = xb.shape[0]
    xb_dim = xb.shape[1]
    
    # read query vectors
    xq = fvecs_read(vector_dataset_path + 'sift_query.fvecs')
    # xq_num = xq.shape[0]
    xq_num = 2
    ...
    # read groundtruth
    groundtruth = ivecs_read(vector_dataset_path + 'sift_groundtruth.ivecs')
