...
base_dataPath = "/app/wwj_test/remote_nvme_vector_datasets/deep1B/base10M.fbin"
groundtruth_dataPath = "/app/wwj_test/remote_nvme_vector_datasets/deep1B/groundtruth-public10K.ibin"
query_dataPath = "/app/wwj_test/remote_nvme_vector_datasets/deep1B/query10K.fbin"

spfresh_index_path = '/app/wwj_test/SPFresh_Index'

csv_log_path = '/app/wwj_test/eva_logs/spfresh_remote_test_deep10M_cpu_disk.csv'
...
def main():
    ...
    # read groundtruth
    groundtruth = deep1B_text1B_dataset.read_ibin(filename=groundtruth_dataPath, start_idx=0, chunk_size=None)
    
    # create SPFresh index and save to disk
    index = SPTAG.AnnIndex('BKT', 'Float', xb_dim)

    index.SetBuildParam("NumberOfThreads", '56', "Index")
